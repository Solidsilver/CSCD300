...
public class ComparableDemo {
	...
	public Object max(Object arr[]) {
		...
		for(Object b : arr) {  //try best to use the enhanced for loop.
			cur = (Employee)b; //We have to type cast b into Employee type, why?
	...
	public int numMale(Object arr[]) {
		return numGender('m', arr);
	}
	
	// This method finds how many female Employees are in the array
	public int numFemale(Object arr[]) {
		return numGender('f', arr);
	}
	
	// This method finds how many of the given gender Employees are in the array
	public int numGender(char gen, Object arr[]) {
		int count = 0;
		Employee cur;
		for (Object b : arr) {
			cur = (Employee) b;
			if (cur.getGender() == gen) {	// This is the correct way to compare character variable with character constant.
	...
	public static void main(String args[]) {
		...
		n = demo.numFemale(arr);
		System.out.println("There are " + n + " female employees in the array.");
